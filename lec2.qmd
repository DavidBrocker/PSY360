...
##  {#custom-title data-menu-title="Three Claims"}

::: title-bg-icons
[fact_check]{.material-icons .title-bg-icon-1} [gavel]{.material-icons .title-bg-icon-2} [trending_up]{.material-icons .title-bg-icon-3} [compare_arrows]{.material-icons .title-bg-icon-4} [quiz]{.material-icons .title-bg-icon-5} [insights]{.material-icons .title-bg-icon-6}
:::
...
[Three Claims]{.cust-title}

[An Interrogation Tool for Consumers of Research]{.cust-sub}
...
![](images/ch3_three_claims/kubrick_stare_1.png){.rounded-fig width="50%"}
